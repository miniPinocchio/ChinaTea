...
public class AbAppUtils {
    ...
    public static int getNumCores() {
        try {
            ...
            //Filter to only mList the devices we care about
     ...
     * 创建桌面快捷方式
     *
     * @param resId 应用图标 <uses-permission
     ...
     * 启动自定义截图工具进行截图
     *
     * @param v        触发截图功能的控件（目前不支持ImageView和ImageButton）
     * @param fileName 生成截图文件的目标路径
     */
    public void screenshot(Context context, View v, String fileName) {
...
//                CacheUtil.getInstance().add("bitmap", bitmap);
//                intent.putExtra("fileName", fileName);
//                context.startActivity(intent);
//                System.out.println("file" + fileName + "output done.");
//            } catch (Exception e) {
//                e.printStackTrace();
//            }
//        } else {
...
//        }
     ...
     * 启动自定义截图工具进行截图`
     *
     * @param bitmap   截图的目标Bitmap(在哪张图片上截图)
     * @param fileName 生成截图文件的目标路径
     */
    public void screenshot(Bitmap bitmap, String fileName) {
//        if (bitmap != null) {
//            System.out.println("bitmap got!");
//            try {
//                Intent intent = new Intent(context, CropActivity.class);
